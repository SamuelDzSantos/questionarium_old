...
import { GabaritoEdicaoScreen, GabaritoScannerScreen, LoginScreen, QRScannerScreen, ResultadoScreen } from './src/app/pages';
...
const AuthenticatedNavigator = () => {
  ...
  <AuthenticatedStack.Navigator screenOptions={styles.header} initialRouteName='QRScanner'>
    <AuthenticatedStack.Screen name="QRScanner" component={QRScannerScreen}
      options={{
        headerTitle: () => <LogoTitleMin title='QR Scanner' />,
        headerRight: () => <LogoutButton />,
      }}
    />
    <AuthenticatedStack.Screen name="GabaritoScanner" component={GabaritoScannerScreen}
      options={{
        headerTitle: () => <LogoTitleMin title='Gabarito Scanner' />,
        headerRight: () => <LogoutButton />,
      }}
    />
    <AuthenticatedStack.Screen name="GabaritoEdicao" component={GabaritoEdicaoScreen}
      options={{
        headerTitle: () => <LogoTitleMin title='Gabarito Edição' />,
        headerRight: () => <LogoutButton />,
      }}
    />
