        ...
        public Flux<CustomModel> getAssessmentModel(@PathVariable Long id, @RequestHeader("X-User-Id") Long userId,
                ...
                return webClient.get()
                                ...
                                .flatMapMany(assessment -> {
                                        ...
                                        System.out.println("------------------------------------------------");
                                        System.out.println(questions.get(0).getQuestionOrder());
                                        return Flux.fromIterable(questions).flatMap(
                                                        q -> webClient.get()
                                                                        .uri("http://localhost:14004/questions/"
                                                                                        + q.getQuestionId())
                                                                        .header("X-User-Id", userId.toString())
                                                                        .header("X-User-isAdmin", isAdmin.toString())
                                                                        .retrieve()
                                                                        .bodyToMono(QuestionDTO.class)
                                                                        .map(question -> new CustomQuestion(
                                                                                        question.getId(),
                                                                                        question.getMultipleChoice(),
                                                                                        question.getNumberLines(),
                                                                                        question.getEducationLevel(),
                                                                                        question.getUserId(),
                                                                                        question.getHeader(),
                                                                                        question.getHeaderImage(),
                                                                                        ...
                                                                                        question.getUpdateDateTime(),
                                                                                        q.getWeight(),
                                                                                        q.getQuestionOrder()))

                                )
                                                        .collectList()
                                                        .map(q -> new CustomModel(assessment.getDescription(),
                                                                        assessment.getInstitution(),
                                                                        assessment.getDepartment(),
                                                                        assessment.getCourse(),
                                                                        assessment.getClassroom(),
                                                                        assessment.getProfessor(),
